...
final class CreateEvent
{
    ...
    public function handle(Organization $organization, User $creator, array $data): Event
    {
        ...
        return Event::query()->create([
            ...
            'registration_opens_at' => isset($data['registration_opens_at']) ? $this->resolveDateTime($data['registration_opens_at'], $data['timezone']) : null,
            'registration_closes_at' => isset($data['registration_closes_at']) ? $this->resolveDateTime($data['registration_closes_at'], $data['timezone']) : null,
